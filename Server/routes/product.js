...
//TESTING ROUTE
router.get("/csraju/signup", (req, res) => {
    res.send("signup Route working!!")
})


//NEW USER
router.post("/api/csraju/signup",
...
router.put("/api/csraju/user/:emailId",
    async (req, res) => {
...
router.get("/api/csraju/userlist", async (req, res) => {
    try {
...
//FIND ALL REGISTER USER
router.delete("/api/csraju/delete/:id", async (req, res) => {
    try {
